import { z } from "zod";
import { getMetaInformationForZodType, SPLIT_DESCRIPTION_SYMBOL, } from "../getMetaInformationForZodType";
describe("getMetaInformationForZodType", () => {
    it("should get the description label if provided", () => {
        ...
        expect((_a = parsed.description) === null || _a === void 0 ? void 0 : _a.label).toStrictEqual(description);
    });
...
//# sourceMappingURL=getMetaInformationForZodType.test.js.map